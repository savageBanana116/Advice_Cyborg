 ...
 * Payments Model
 *
 * @property \App\Model\Table\PaymentProvidersTable&\Cake\ORM\Association\BelongsTo $PaymentProviders
...
class PaymentsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('PaymentProviders', [
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ...
            ->notEmptyDateTime('payment_date', 'The payment date is required.');
    ...
    {
        $rules->add($rules->existsIn(['payment_provider_id'], 'PaymentProviders'), ['errorField' => 'payment_provider_id']);
