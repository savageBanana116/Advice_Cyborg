    ...
    <div class="container-fluid">
        ...
        <div class="row" style="justify-content: center;margin-top: 2vh">
            ...
            <div class="row" style="margin-bottom:0.5em">
                <button style="width:35%;" type="button" onclick="location.href='super_contribution' "  class="btn btn-primary" style="font-size: 2vh; border-radius: 12px; text-transform: uppercase">Contribution to Super (Coming Soon)</button>
            </div>
            <div class="row" style="margin-bottom:0.5em">
<!--                <button type="button" onclick="location.href='risk_profile' " class="btn btn-primary" style="font-size: 2vh; border-radius: 12px; text-transform: uppercase">Investment portfolio</button>-->
            ...
            <div class="row" style="margin-bottom:0.5em">
                <button style="width:35%;" type="button" onclick="location.href='consolidate_super' " class="btn btn-primary" style="font-size: 2vh; border-radius: 12px; text-transform: uppercase">Consolidate Super (Coming Soon)</button>
            </div>
            <div class="row" style="margin-bottom:0.5em">
